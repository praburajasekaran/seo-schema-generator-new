      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b border-slate-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-slate-900">Manual Content Input</h2>
              <p className="text-sm text-slate-600">Enter content manually when automatic extraction fails</p>
            </div>
          </div>
          <button
            onClick={onCancel}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            <label htmlFor="pageTitle" className="block text-sm font-medium text-slate-700 mb-2">
              Page Title *
            </label>
            <input
              type="text"
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              ...
              className="flex-1 px-4 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-slate-300 text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
